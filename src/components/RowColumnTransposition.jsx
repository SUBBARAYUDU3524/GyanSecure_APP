  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.text}>
        <Text style={styles.bold}>Determine the key:</Text> The key is a
        permutation of column indices (e.g., 3 1 4 2), which determines the
        order in which the columns will be read to form the ciphertext.
      </Text>
      <Text style={styles.text}>
        <Text style={styles.bold}>Write the plaintext in rows:</Text> Arrange
        the plaintext into a grid of rows and columns based on the length of the
        key. Add padding (if necessary) to fill empty spaces.
      </Text>
      <Text style={styles.text}>
        <Text style={styles.bold}>Read the columns in the key order:</Text>{' '}
        Generate the ciphertext by reading the columns in the order specified by
        the key.
      </Text>

      <Text style={styles.sectionHeading}>Decryption:</Text>
      <Text style={styles.text}>
        <Text style={styles.bold}>Recreate the grid:</Text> Create a grid with
        the same number of columns as the key and fill it column by column in
        the order of the key.
      </Text>
      <Text style={styles.text}>
        <Text style={styles.bold}>Read row by row:</Text> Recover the plaintext
      ...
      <Text style={styles.text}>
        Rearrange columns to form the original grid:
      </Text>
      <View style={styles.codeBlock}>
        <Text>M E E T</Text>
        <Text>M E A T</Text>
