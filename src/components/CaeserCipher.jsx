...
export default function CaesarCipher() {
      ...
      .map(char => {
        if (/[a-zA-Z]/.test(char)) {
          ...
          return String.fromCharCode(
            ((code - base - shiftValue + 26) % 26) + base,
          );
        }
        return char;
      })
  ...
  const handleEncrypt = () => {
    const result = caesarEncrypt(encryptionPlaintext, encryptionShift);
    setCiphertext(result);
    setDecryptionShift(encryptionShift);
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View>
        <Text style={styles.mainheader}>
          Algorithm For the Encryption & Decryption
        </Text>
        ...
        <Text style={styles.bulletPoint}>
          ● Determine the letter's position in the alphabet (A=0, B=1, ...,
          Z=25).
        </Text>
        <Text style={styles.bulletPoint}>
      ...
      <Animated.View style={[styles.card, encryptStyle]}>
        ...
        <TextInput
          ...
          onChangeText={text =>
            handleTextChange(text, setEncryptionShift, true)
          } // Allow only numbers
      ...
      <Animated.View style={[styles.card, decryptStyle]}>
        ...
        <TextInput
          ...
          onChangeText={text =>
            handleTextChange(text, setDecryptionShift, true)
          } // Allow only numbers
          keyboardType="numeric" // Show numeric keyboard
        />
        <TextInput
        ...
        <Button
          ...
          onPress={() =>
            setDecryptedText(
              caesarDecrypt(decryptionCiphertext, decryptionShift),
            )
          }
        />
        {decryptedText ? (
