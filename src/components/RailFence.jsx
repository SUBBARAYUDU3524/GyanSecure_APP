    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {'\n'}This is the number of rows across which the plaintext will be
        ...
        <Text style={styles.text}>
          ...
          {'\n'}The plaintext is written diagonally down and up in a zigzag
          manner across the rails.
        </Text>
        <Text style={styles.text}>
          3. <Text style={styles.bold}>Read the rows sequentially:</Text>
          {'\n'}After filling the rails in the zigzag pattern, the ciphertext is
          formed by reading the content of each rail row by row.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {'\n'}To decrypt, the number of rails must be known. The zigzag
          pattern of the ciphertext is reconstructed using the number of rails.
        </Text>
        <Text style={styles.text}>
          2. <Text style={styles.bold}>Extract the plaintext:</Text>
          {'\n'}The original plaintext is then recovered by reading the
          characters in the zigzag pattern.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {'\n'}First, we arrange the plaintext across 3 rails in a zigzag
          pattern:
        </Text>
        ...
        <Text style={styles.text}>The zigzag pattern looks like this:</Text>
        <Text style={styles.codeBlock}>
          Rail 1: A C D {'\n'}
          Rail 2: T A K T A N {'\n'}
          Rail 3: T A W
        ...
        <Text style={styles.subheading}>
          Read the rows sequentially to form the ciphertext:
        </Text>
        <Text style={styles.text}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          We start by creating a 3-rail grid, as per the number of rails. The
          ciphertext is placed in the zigzag pattern:
        </Text>
        <Text style={styles.codeBlock}>
          Rail 1: A . . . A . . . T . . . A . .{'\n'}
